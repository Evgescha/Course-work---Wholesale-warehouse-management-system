...
public class EmployeeFrame extends JFrame {
	...
	private void actionDeleteButton() {
		if(table.getRowCount()>0 && table.getSelectedRowCount()>0) {
			...
			ApplicationController.employeeController.actionDeleteButton(Long.parseLong(id));
		}
	}
	...
	private void actionUpdateButton() {
		...
		ApplicationController.employeeController.actionUpdateButton(textField_1.getText().trim(), textField_2.getText().trim(), textField_3.getText().trim(), id);
	}

	private void actionCreateButton() {
		ApplicationController.employeeController.actionCreateButton(textField_1.getText().trim(), textField_2.getText().trim(), textField_3.getText().trim());
	}

	private void actionSearchButton() {
		ApplicationController.employeeController.actionSearchButton(textField.getText().trim(), table);
	}

	public void refreshView() {
		ApplicationController.employeeController.actionSearchButton("", table);
	}
